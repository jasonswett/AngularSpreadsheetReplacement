...
//Feeds
  $routeProvider.when('/feeds/:id/', {templateUrl: 'partials/feed.html', controller: 'feedsCtrl'});
    $routeProvider.when('/feedEdit/:id/', {templateUrl: 'partials/feedEdit.html', controller: 'feedsCtrl'});
